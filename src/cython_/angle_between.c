 ...
 */
  __pyx_t_1 = atan2((__pyx_v_y1 - __pyx_v_y2), (__pyx_v_x2 - __pyx_v_x1));
  __pyx_t_2 = (2.0 * M_PI);
...
static PyObject *__pyx_pw_2zs_9cython__13angle_between_1angle_between(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("angle_between (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("angle_between", 1, 4, 4, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("angle_between", 1, 4, 4, 2); __PYX_ERR(0, 11, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("angle_between", 1, 4, 4, 3); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "angle_between") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
    ...
    __pyx_v_x1 = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_x1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_y1 = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_y1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_x2 = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_x2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
    __pyx_v_y2 = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_y2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
...
static int __pyx_pymod_exec_angle_between(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_angle_between},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_u_Get_angle_of_the_hypotenuse_to_t, __pyx_k_Get_angle_of_the_hypotenuse_to_t, sizeof(__pyx_k_Get_angle_of_the_hypotenuse_to_t), 0, 1, 0, 0},
  {&__pyx_kp_u_angle_between_line_11, __pyx_k_angle_between_line_11, sizeof(__pyx_k_angle_between_line_11), 0, 1, 0, 0},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initangle_between(void); /*proto*/
PyMODINIT_FUNC initangle_between(void)
#else
PyMODINIT_FUNC PyInit_angle_between(void); /*proto*/
PyMODINIT_FUNC PyInit_angle_between(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_angle_between(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_angle_between(void)", 0);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_angle_between_line_11, __pyx_kp_u_Get_angle_of_the_hypotenuse_to_t) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
